...
public final class Compiler {
  ...
  /**
   * Compiles a single source file and loads the class with a default class
   * loader. The default class loader is the one used to load the test case
   * class.
   * 
   * @param name
   ...
   * @param parentLoader
   *          the parent class loader to use when loading classes.
   * 
   * @return a map of compiled classes. This maps class names to Class objects.
   * @throws Exception
   * 
   */
  private Class<?> compileSource0(String className, String sourceCode) throws Exception {
    ...
    log.debug("Running compiler with options: " + compilerOptions);
